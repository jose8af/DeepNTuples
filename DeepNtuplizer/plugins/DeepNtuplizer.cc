...
DeepNtuplizer::endJob()
{
  ...
  njets_leptonic_ = ntuple_JetInfo::getNJetsWOLeptonMatch();
  ...
  std::cout << "total number of leptonic jets: "<< (float)njets_leptonic_ <<std::endl;
  ...
  std::cout << "fraction of jets with lepton match: "<< (float)njets_with_lepton_match_/(float)njets_leptonic_ <<std::endl;
